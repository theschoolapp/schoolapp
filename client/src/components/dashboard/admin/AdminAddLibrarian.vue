    ...
    <div class="container-fluid vue-page-container">
          <div class="row">
            <div class="col-lg-12 clear-padding-xs">
              <h5 class="page-title"><i class="fa fa-user-secret"></i>ADD LIBRARIAN</h5>
                  ...
                  <div class="inner-item">
                    <div class="dash-form">
                      ...
                      <div class="col-sm-3">
                        ...
                        <input type="text" v-model="lib.dob" placeholder="MM/DD/YYYY" />
                      </div>
                      
                      
                      <div class="col-sm-3">
                        <label><i class="fa fa-bell-o"></i>RELIGION</label>
                        <select v-model="lib.religion">
                          <option>-- Select --</option>
                  ...
                  <div class="inner-item">
                    <div class="dash-form">
                      ...
                      <div class="col-sm-3">
                        ...
                        <input type="text" v-model="lib.address" placeholder="H/N 42 Street# 10" />
                      </div>
                      <div class="col-sm-3">
                        <label class="clear-top-margin"><i class="fa fa-phone"></i>PHONE #</label>
                        <input type="text" v-model="lib.phoneNumber1" placeholder="077 000 000" />
                      </div>
                      <div class="col-sm-3">
                        <label class="clear-top-margin"><i class="fa fa-phone"></i>ALTERNATE PHONE #</label>
                        <input type="text" v-model="lib.phoneNumber2" placeholder="077 000 000" />
                      </div>
                      <div class="col-sm-3">
                        <label class="clear-top-margin"><i class="fa fa-envelope-o"></i>EMAIL</label>
                        <input type="email" v-model="lib.email" placeholder="email@host.com" />
                      </div>
                  ...
                  <div class="inner-item">
                    <div class="dash-form">
                      <div class="col-sm-3">
                        ...
                        <input type="text" v-model="lib.highestDegree" placeholder="PhD" />
                      </div>
                      <div class="col-sm-3">
                        <label class="clear-top-margin"><i class="fa fa-building"></i>UNIVERSITY/COLLEGE</label>
                         <input type="text" v-model="lib.university" placeholder="University" />
                      </div>
                      <div class="col-sm-3">
                        <label class="clear-top-margin"><i class="fa fa-calaendar"></i>YEAR PASSED</label>
                       <input type="text" v-model="lib.graduatingYear" placeholder="YYYY" />
                      </div>
                      <div class="col-sm-3">
                        <label class="clear-top-margin"><i class="fa fa-puzzle-piece"></i>CGPA</label>
                        <input type="text" v-model="lib.CGPA" placeholder="08.65" />
                      </div>
                      <div class="clearfix"></div>
                      <div class="col-sm-3">
                        <label><i class="fa fa-graduation-cap"></i>OTHER DEGREE</label>
                        <input type="text"  v-model="lib.otherDegrees[0]" placeholder="MSc" />
                      </div>
                      <div class="col-sm-3">
                      ...
                      <div v-if="showAlert" class="col-sm-12">
                        <div class="alert alert-success alert-dismissible vue-alert" role="alert">
                          ...
                          <strong><i class="fa fa-check-square-o" aria-hidden="true"></i> Success</strong> New librarian created successfully.
                        </div>
                      </div>
                    </div>
                    <div class="clearfix"></div>
...
export default {
  ...
  methods: {
    submitForm(event){
      ...
      this.axios.post("http://localhost:5000/admin/addLibrarian", data)
      .then((resp) => {
