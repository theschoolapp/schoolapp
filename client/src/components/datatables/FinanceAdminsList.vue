    ...
    <table id="libList" class=" table table-striped table-bordered display responsive nowrap" cellspacing="0" width="100%">
                      ...
                      <tbody>
                        <tr v-for="lib in tableData" :key="lib.id">
                          <td>{{lib.firstName}}, {{lib.lastName}}</td>
                  ...
                  :width="598">
                    ...
                    <div class="modal-content">
                      <div class="modal-header">
                        ...
                        <h4 class="modal-title"><i class="fa fa-trash"></i>DELETE FINANCE ADMIN</h4>
                      </div>
                      <div class="modal-body">
                            
                            <div class="alert alert-success vue-alert" role="alert">
                              <strong><i class="fa fa-check-square-o" aria-hidden="true"></i> Are you sure you want to delete this admin, </strong>{{deleteLib[0]}}<strong> ?</strong>
                            </div>
        ...
        <div class="modal-content">
          <div class="modal-header">
            ...
            <h4 class="modal-title"><i class="fa fa-edit"></i>EDIT FINANCE ADMIN DETAILS</h4>
          </div>

          <div class="modal-body editModal-body">

           <div class="dash-item first-dash-item">
                  <h6 class="item-title"><i class="fa fa-user"></i>FINANCE ADMIN INFO</h6>
