                  ...
                  :width="598">
                    ...
                    <div class="modal-content">
                      <div class="modal-header">
                        ...
                        <h4 class="modal-title"><i class="fa fa-trash"></i>DELETE LIBRARIAN</h4>
                      </div>
                      <div class="modal-body">
                            
                            <div class="alert alert-success vue-alert" role="alert">
                              <strong><i class="fa fa-check-square-o" aria-hidden="true"></i> Are you sure you want to delete this student, </strong>{{deleteLib[0]}}<strong> ?</strong>
                            </div>
