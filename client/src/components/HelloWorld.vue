<template>
  <div class="hello">
                        ...
                        <ul class="nav navbar-nav">
							...
							<li class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li><a href="dashboard/student-dashboard.html"><i class="fa fa-child"></i>PARENT</a></li>
                                </ul>
                            </li>
		...
		<div class="row principal-intro-row">
			<div class="container">
				<div class="col-sm-5">
					<img src="/assets/img/parent/parent1.jpg" alt="Our Principal"/>
				</div>
			...
			<div class="container">
				...
				<div class="col-md-3 col-sm-6 footer-item">
					...
					<div class="footer-subscribe">
						<a> <i class="fa fa-envelope"></i></a><input type="text" placeholder="example@Prototype.com" />
					</div>
